...
module.exports = {
  ...
  STICKER_PACK : '[ MIRZA ]',
  BAD_WORDS : 'fuck,lora,bc,mc,bsdk,randi,l0ra,penic,lun,lowra,lowre,gand,gandu,vagina,chutiya,stef,chutya,mirza,muthal,madarchod,bhen,chod,',
  ANTI_BAD : true,
  ANTI_LINKS : 'whatsapp.com',
  ANTI_LINK : whatsapp.com,
  ANTI_LINK_KICK : true,
  MAX_SIZE : 100,
  MOROCCO_NUMBERS : {
        BLOCK : false,
